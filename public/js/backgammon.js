...
var Backgammon = {
    ...
    Board: function(boardElementId) {
        ...
        $board.append($('<div id="black-bar" class="bar">'));
        ...
        $board.append($('<div id="black-home" class="pip">'));
        ...
        $board.append($('<div id="red-bar" class="bar">'));
        ...
        $board.append($('<div id="red-home" class="pip">'));
        $board.append($('<br class="clear" />'));
