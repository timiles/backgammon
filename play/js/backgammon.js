...
define("Bar", ["require", "exports", "CheckerContainer", "Board"], function (require, exports, CheckerContainer_1, Board_1) {
    ...
    var Bar = (function (_super) {
        ...
        function Bar() {
            _super.call(this, Board_1.PointId.BAR);
        }
...
define("DiceUI", ["require", "exports", "Enums", "UI/Utils"], function (require, exports, Enums_1, Utils_1) {
    "use strict";
    var DiceUI = (function () {
        function DiceUI(player) {
            this.containerDiv = document.createElement('div');
            this.containerDiv.className = "dice-container dice-container-" + Enums_1.PlayerId[player].toLowerCase();
        }
...
define("Dice", ["require", "exports", "Die", "Enums"], function (require, exports, Die_1, Enums_2) {
    ...
    var Dice = (function () {
        function Dice(diceRollGenerator, blackDiceUI, redDiceUI) {
            ...
            this.diceUIs[Enums_2.PlayerId.BLACK] = blackDiceUI;
            this.diceUIs[Enums_2.PlayerId.RED] = redDiceUI;
        }
        Dice.prototype.rollToStart = function (statusLogger, onSuccess) {
            ...
            this.diceUIs[Enums_2.PlayerId.BLACK].setStartingDiceRoll(die1);
            this.diceUIs[Enums_2.PlayerId.RED].setStartingDiceRoll(die2);
            ...
            if (die1.value === die2.value) {
                ...
                var successfulPlayer_1 = die1.value > die2.value ? Enums_2.PlayerId.BLACK : Enums_2.PlayerId.RED;
                statusLogger.logInfo(Enums_2.PlayerId[successfulPlayer_1] + " wins the starting roll");
                setTimeout(function () {
                    _this.die1 = die1;
                    _this.die2 = die2;
        ...
        Dice.prototype.roll = function (player) {
            ...
            var otherPlayer = player === Enums_2.PlayerId.BLACK ? Enums_2.PlayerId.RED : Enums_2.PlayerId.BLACK;
...
define("Game", ["require", "exports", "Bar", "Board", "Board", "ComputerPlayer", "Point", "Enums", "Home", "HumanPlayer"], function (require, exports, Bar_1, Board_5, Board_6, ComputerPlayer_1, Point_1, Enums_5, Home_1, HumanPlayer_1) {
    ...
    var Game = (function () {
        ...
        Game.prototype.evaluateBoard = function () {
            ...
            this.board.checkerContainers[Board_6.PointId.BAR].setValidSource(this.currentPlayerId, isValidSource(Board_6.PointId.BAR));
            for (var i = 1; i <= 24; i++) {
...
define("UI/BoardUI", ["require", "exports", "UI/BarUI", "UI/HomeUI", "UI/PointUI", "Board", "Enums", "UI/Utils"], function (require, exports, BarUI_1, HomeUI_1, PointUI_1, Board_7, Enums_10, Utils_4) {
    ...
    var BoardUI = (function () {
        ...
        BoardUI.prototype.bindEvents = function (board) {
            ...
            this.redHomeUI.onSelected = function () { return board.onPointSelected(Board_7.PointId.HOME); };
            this.blackBarUI.onInspected = function (on) { return board.onPointInspected(Board_7.PointId.BAR, on); };
            this.blackBarUI.onSelected = function () { return board.onPointSelected(Board_7.PointId.BAR); };
            this.redBarUI.onInspected = function (on) { return board.onPointInspected(Board_7.PointId.BAR, on); };
            this.redBarUI.onSelected = function () { return board.onPointSelected(Board_7.PointId.BAR); };
            ...
            board.onCheckerCountChanged = function (pointId, playerId, count) {
                switch (pointId) {
                    case Board_7.PointId.HOME: {
                        getHomeUI(playerId).setCheckers(playerId, count);
                        break;
                    }
                    case Board_7.PointId.BAR: {
